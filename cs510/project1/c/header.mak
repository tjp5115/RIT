...
# and linking C programs which use SFML and GSL on the CS Ubuntu systems.
# IT WILL NOT WORK CORRECTLY FOR C++ PROGRAMS.
#
...
LDLIBS = -lgsl -lgslcblas -lcsfml-graphics -lcsfml-window

CFLAGS = -g -std=c99 $(INCLUDE)
CCFLAGS =  $(CFLAGS)
CXXFLAGS = $(CFLAGS)
